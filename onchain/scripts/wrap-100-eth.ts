...
async function main() {
	...
	console.log("Wrapping 100 ETH to WETH for multiple accounts...")
	
	// Wrap for first 5 accounts (100 ETH each)
	for (let i = 0; i < 5; i++) {
	...
	console.log("\n🎉 Done wrapping 100 ETH to WETH for multiple accounts!")
}
